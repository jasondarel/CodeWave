    ...
    <div class="container">
        ...
        <div class="chapter-list">
            ...
            <ul>
                ...
                <li class="active"><a href="/my-courses/dawp/dawp04">Chapter 4: Data Visualization using Matplotlib and Seaborn</a></li>
        ...
        <div class="main-content">
            ...
            <div class="next-chapter">
                <a href="/my-courses/dawp/dawp05" class="next-chapter-button">Next Chapter</a>
            </div>
        </div>
    </div>
