...
<body>
    ...
    <div class="container">
        ...
        <div class="chapter-list">
            <h3>CHAPTERS</h3>
            <ul>
                <li class="active"><a href="/my-courses/dawp/dawp01">Chapter 1: Data Manipulation with Pandas and NumPy</a></li>
        ...
        <div class="main-content">
            ...
            <div class="next-chapter">
                <a href="/my-courses/dawp/dawp02" class="next-chapter-button">Next Chapter</a>
            </div>
        </div>
    </div>
