    ...
    <div class="container">
        ...
        <div class="chapter-list">
            ...
            <ul>
                ...
                <li class="active"><a href="/my-courses/pfc/pfc03">Chapter 3: Automating Penetration Testing Tasks</a></li>
...
automate_pen_test("192.168.1.10")
            ...
            <div class="next-chapter">
                <a href="/my-courses/pfc/pfc04" class="next-chapter-button">Next Chapter</a>
            </div>
        </div>
    </div>
