...
<body>
    ...
    <div class="container">
        ...
        <div class="chapter-list">
            <h3>CHAPTERS</h3>
            <ul>
                <li><a href="/my-courses/pfc/pfc01">Chapter 1: Introduction to Python for Security Tasks</a></li>
                <li class="active"><a href="/my-courses/pfc/pfc02">Chapter 2: Network Scanning and Reconnaissance with Python</a></li>
...
print(f"Open ports on {target_ip}: {open_ports}")
            ...
            <div class="next-chapter">
                <a href="/my-courses/pfc/pfc03" class="next-chapter-button">Next Chapter</a>
            </div>
        </div>
    </div>
