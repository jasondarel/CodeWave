    ...
    <div class="container">
        ...
        <div class="chapter-list">
            ...
            <ul>
                ...
                <li><a href="/my-courses/pfa/pfa03">Chapter 3: Automating Emails and Other Web Tasks</a></li>
                <li><a href="/my-courses/pfa/pfa04">Chapter 4: Working with APIs for Data Retrieval and Automation</a></li>
                <li class="active"><a href="/my-courses/pfa/pfa05">Chapter 5: Scheduling and Running Automated Tasks with Python</a></li>
            </ul>
        </div>
...
job()
            ...
            <div class="next-chapter">
                <a href="/my-courses/pfa" class="next-chapter-button">Return to Course Overview</a>
            </div>
        </div>
    </div>
