    ...
    <div class="container">
        ...
        <div class="chapter-list">
            ...
            <ul>
                ...
                <li class="active"><a href="/my-courses/pfa/pfa02">Chapter 2: Web Scraping using BeautifulSoup and Selenium</a></li>
...
driver.quit()
            ...
            <div class="next-chapter">
                <a href="/my-courses/pfa/pfa03" class="next-chapter-button">Next Chapter</a>
            </div>
        </div>
    </div>
