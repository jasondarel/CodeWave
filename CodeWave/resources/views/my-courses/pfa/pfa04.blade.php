    ...
    <div class="container">
        ...
        <div class="chapter-list">
            ...
            <ul>
                ...
                <li class="active"><a href="/my-courses/pfa/pfa04">Chapter 4: Working with APIs for Data Retrieval and Automation</a></li>
...
if response.status_code == 200:
    ...
    print('Failed to authenticate and retrieve data')
            ...
            <div class="next-chapter">
                <a href="/my-courses/pfa/pfa05" class="next-chapter-button">Next Chapter</a>
            </div>
        </div>
    </div>
