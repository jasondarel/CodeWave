...
<body>
    ...
    <div class="container">
        ...
        <div class="chapter-list">
            <h3>CHAPTERS</h3>
            <ul>
                <li class="active"><a href="/my-courses/pfa/pfa01">Chapter 1: Automating File and Folder Management with Python</a></li>
...
os.rmdir('new_folder')
            ...
            <div class="next-chapter">
                <a href="/my-courses/pfa/pfa02" class="next-chapter-button">Next Chapter</a>
            </div>
        </div>
    </div>
