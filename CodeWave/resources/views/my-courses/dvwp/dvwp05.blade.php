    ...
    <div class="container">
        ...
        <div class="chapter-list">
            ...
            <ul>
                ...
                <li><a href="/my-courses/dvwp/dvwp02">Chapter 2: Creating Static Plots with Matplotlib</a></li>
                ...
                <li class="active"><a href="/my-courses/dvwp/dvwp05">Chapter 5: Using Visualization for Data Analysis and Reporting</a></li>
            </ul>
        </div>
        ...
        <div class="main-content">
            ...
            <div class="next-chapter">
                <a href="/my-courses/dvwp" class="next-chapter-button">Return to Course Overview</a>
            </div>
        </div>
    </div>
