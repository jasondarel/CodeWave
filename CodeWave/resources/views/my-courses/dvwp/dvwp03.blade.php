    ...
    <div class="container">
        ...
        <div class="chapter-list">
            ...
            <ul>
                ...
                <li class="active"><a href="/my-courses/dvwp/dvwp03">Chapter 3: Building Advanced Visualizations using Seaborn</a></li>
        ...
        <div class="main-content">
            ...
            <div class="next-chapter">
                <a href="/my-courses/dvwp/dvwp04" class="next-chapter-button">Next Chapter</a>
            </div>
        </div>
    </div>
