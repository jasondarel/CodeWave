...
<body>
    ...
    <div class="container">
        ...
        <div class="chapter-list">
            <h3>CHAPTERS</h3>
            <ul>
                <li class="active"><a href="/my-courses/dvwp/dvwp01">Chapter 1: Introduction to Data Visualization with Python</a></li>
        ...
        <div class="main-content">
            ...
            <div class="next-chapter">
                <a href="/my-courses/dvwp/dvwp02" class="next-chapter-button">Next Chapter</a>
            </div>
        </div>
    </div>
