    ...
    <div class="container">
        ...
        <div class="chapter-list">
            ...
            <ul>
                ...
                <li class="active"><a href="/my-courses/app/app02">Chapter 2: Functional Programming Concepts and Tools in Python</a></li>
        ...
        <div class="main-content">
            ...
            <div class="next-chapter">
                <a href="/my-courses/app/app03" class="next-chapter-button">Next Chapter</a>
            </div>
        </div>
    </div>
