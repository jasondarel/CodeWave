...
<body>
    ...
    <div class="container">
        ...
        <div class="chapter-list">
            <h3>CHAPTERS</h3>
            <ul>
                <li><a href="/my-courses/app/app01">Chapter 1: Advanced Object-Oriented Programming Techniques</a></li>
                ...
                <li class="active"><a href="/my-courses/app/app04">Chapter 4: Concurrency and Parallelism with Threading and Multiprocessing</a></li>
        ...
        <div class="main-content">
            ...
            <div class="next-chapter">
                <a href="/my-courses/app/app05" class="next-chapter-button">Next Chapter</a>
            </div>
        </div>
    </div>
