...
<body>
    ...
    <div class="container">
        ...
        <div class="chapter-list">
            <h3>CHAPTERS</h3>
            <ul>
                <li><a href="/my-courses/je/je01">Chapter 1: Understanding JavaScript syntax and data types</a></li>
                ...
                <li class="active"><a href="/my-courses/je/je05">Chapter 5: Working with arrays and objects in JavaScript</a></li>
            </ul>
        </div>
        ...
        <div class="main-content">
            ...
            <div class="next-chapter">
                <a href="/my-courses/je" class="next-chapter-button">Return to Course Overview</a>
            </div>
        </div>
    </div>
