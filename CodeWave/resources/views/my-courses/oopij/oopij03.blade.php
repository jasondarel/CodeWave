    ...
    <div class="container">
        ...
        <div class="chapter-list">
            ...
            <ul>
                ...
                <li class="active"><a href="/my-courses/oopij/oopij03">Chapter 3: Implementing Inheritance and Polymorphism</a></li>
        ...
        <div class="main-content">
            ...
            <div class="next-chapter">
                <a href="/my-courses/oopij/oopij04" class="next-chapter-button">Next Chapter</a>
            </div>
        </div>
    </div>
