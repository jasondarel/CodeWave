    ...
    <div class="container">
        ...
        <div class="chapter-list">
            ...
            <ul>
                ...
                <li class="active"><a href="/my-courses/oopij/oopij04">Chapter 4: Using Encapsulation and Access Modifiers</a></li>
        ...
        <div class="main-content">
            ...
            <div class="next-chapter">
                <a href="/my-courses/oopij/oopij05" class="next-chapter-button">Next Chapter</a>
            </div>
        </div>
    </div>
