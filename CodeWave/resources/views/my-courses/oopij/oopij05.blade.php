...
<body>
    ...
    <div class="container">
        ...
        <div class="chapter-list">
            <h3>CHAPTERS</h3>
            <ul>
                <li><a href="/lessons/oopij/oopij01">Chapter 1: Introduction to Object-Oriented Programming in Java</a></li>
                ...
                <li class="active"><a href="/lessons/oopij/oopij05">Chapter 5: Achieving Abstraction through Abstract Classes and Interfaces</a></li>
            </ul>
        </div>
        ...
        <div class="main-content">
            ...
            <div class="next-chapter">
                <a href="/lessons/oopij" class="next-chapter-button">Return to Course Overview</a>
            </div>
        </div>
    </div>
