    ...
    <div class="container">
        ...
        <div class="chapter-list">
            ...
            <ul>
                ...
                <li><a href="/my-courses/jwdwsb/jwdwsb03">Chapter 3: Connecting Your Spring Boot Application to a Database</a></li>
                <li class="active"><a href="/my-courses/jwdwsb/jwdwsb04">Chapter 4: Implementing Authentication and Authorization using Spring Security</a></li>
        ...
        <div class="main-content">
            ...
            <div class="next-chapter">
                <a href="/my-courses/jwdwsb/jwdwsb05" class="next-chapter-button">Next Chapter</a>
            </div>
        </div>
    </div>
