    ...
    <div class="container">
        ...
        <div class="chapter-list">
            ...
            <ul>
                ...
                <li class="active"><a href="/my-courses/jwdwsb/jwdwsb02">Chapter 2: Building and Consuming RESTful APIs</a></li>
        ...
        <div class="main-content">
            ...
            <div class="next-chapter">
                <a href="/my-courses/jwdwsb/jwdwsb03" class="next-chapter-button">Next Chapter</a>
            </div>
        </div>
    </div>
