...
<body>
    ...
    <div class="container">
        ...
        <div class="chapter-list">
            <h3>CHAPTERS</h3>
            <ul>
                <li><a href="/my-courses/fsdwn/fsdwn01">Chapter 1: Setting up a Node.js server with Express</a></li>
                <li><a href="/my-courses/fsdwn/fsdwn02">Chapter 2: Building RESTful APIs with Express</a></li>
                <li><a href="/my-courses/fsdwn/fsdwn03">Chapter 3: Handling user authentication and authorization</a></li>
                <li class="active"><a href="/my-courses/fsdwn/fsdwn04">Chapter 4: Working with MongoDB and other databases</a></li>
                <li><a href="/my-courses/fsdwn/fsdwn05">Chapter 5: Integrating frontend with backend using React or any other JS framework</a></li>
                <li><a href="/my-courses/fsdwn/fsdwn06">Chapter 6: Deploying full-stack applications to production</a></li>
            </ul>
        </div>
...
mongoose.connect('mongodb://localhost:27017/fsdwn_db', {
...
User.deleteOne({ username: 'john_doe' })
    ...
    .catch(err => console.log(err));
            ...
            <div class="next-chapter">
                <a href="/my-courses/fsdwn/fsdwn05" class="next-chapter-button">Next Chapter</a>
            </div>
        </div>
    </div>
