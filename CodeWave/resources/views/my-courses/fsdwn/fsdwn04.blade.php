    ...
    <div class="container">
        ...
        <div class="chapter-list">
            ...
            <ul>
                ...
                <li class="active"><a href="/lessons/fsdwn/fsdwn04">Chapter 4: Working with MongoDB and other databases</a></li>
                <li><a href="/lessons/fsdwn/fsdwn05">Chapter 5: Integrating frontend with backend using React or any other JS framework</a></li>
                <li><a href="/lessons/fsdwn/fsdwn06">Chapter 6: Deploying full-stack applications to production</a></li>
            </ul>
        </div>
