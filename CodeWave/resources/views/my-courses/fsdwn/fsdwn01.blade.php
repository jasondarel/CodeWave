...
<body>
    ...
    <div class="container">
        ...
        <div class="chapter-list">
            <h3>CHAPTERS</h3>
            <ul>
                <li class="active"><a href="/my-courses/fsdwn/fsdwn01">Chapter 1: Setting up a Node.js server with Express</a></li>
                ...
                <li><a href="/my-courses/fsdwn/fsdwn04">Chapter 4: Working with MongoDB and other databases</a></li>
...
app.post('/submit', (req, res) => {
    res.send('Form submitted!');
            ...
            <div class="next-chapter">
                <a href="/my-courses/fsdwn/fsdwn02" class="next-chapter-button">Next Chapter</a>
            </div>
        </div>
    </div>
