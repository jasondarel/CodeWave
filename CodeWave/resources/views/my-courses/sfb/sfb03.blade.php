    ...
    <div class="container">
        ...
        <div class="chapter-list">
            ...
            <ul>
                ...
                <li class="active"><a href="/my-courses/sfb/sfb03">Chapter 3: Working with Spring Dependency Injection (DI)</a></li>
        ...
        <div class="main-content">
            ...
            <div class="next-chapter">
                <a href="/my-courses/sfb/sfb04" class="next-chapter-button">Next Chapter</a>
            </div>
        </div>
    </div>
