...
<body>
    ...
    <div class="container">
        ...
        <div class="chapter-list">
            <h3>CHAPTERS</h3>
            <ul>
                <li class="active"><a href="/my-courses/sfb/sfb01">Chapter 1: Introduction to the Spring Framework and its features</a></li>
                ...
                <li><a href="/my-courses/sfb/sfb05">Chapter 5: Testing and deploying Spring applications</a></li>
            </ul>
        </div>
        ...
        <div class="main-content">
            ...
            <div class="next-chapter">
                <a href="/my-courses/sfb/sfb02" class="next-chapter-button">Next Chapter</a>
            </div>
        </div>
    </div>
