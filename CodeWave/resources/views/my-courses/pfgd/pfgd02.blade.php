    ...
    <div class="container">
        ...
        <div class="chapter-list">
            ...
            <ul>
                ...
                <li class="active"><a href="/my-courses/pfgd/pfgd02">Chapter 2: Setting Up the Pygame Library and Game Loop</a></li>
        ...
        <div class="main-content">
            ...
            <div class="next-chapter">
                <a href="/my-courses/pfgd/pfgd03" class="next-chapter-button">Next Chapter</a>
            </div>
        </div>
    </div>
