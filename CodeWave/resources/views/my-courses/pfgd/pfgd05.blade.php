    ...
    <div class="container">
        ...
        <div class="chapter-list">
            ...
            <ul>
                ...
                <li class="active"><a href="/my-courses/pfgd/pfgd05">Chapter 5: Building a Final Game Project</a></li>
            </ul>
        </div>
        ...
        <div class="main-content">
            ...
            <div class="next-chapter">
                <a href="/my-courses/pfgd" class="next-chapter-button">Return to Course Overview</a>
            </div>
        </div>
    </div>
