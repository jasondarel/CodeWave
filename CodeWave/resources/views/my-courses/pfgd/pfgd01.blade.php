...
<body>
    ...
    <div class="container">
        ...
        <div class="chapter-list">
            <h3>CHAPTERS</h3>
            <ul>
                <li class="active"><a href="/my-courses/pfgd/pfgd01">Chapter 1: Introduction to Game Development with Python</a></li>
                ...
                <li><a href="/my-courses/pfgd/pfgd04">Chapter 4: Implementing Game Logic, Physics, and Collision Detection</a></li>
        ...
        <div class="main-content">
            ...
            <div class="next-chapter">
                <a href="/my-courses/pfgd/pfgd02" class="next-chapter-button">Next Chapter</a>
            </div>
        </div>
    </div>
