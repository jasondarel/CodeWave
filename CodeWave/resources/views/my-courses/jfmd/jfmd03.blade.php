    ...
    <div class="container">
        ...
        <div class="chapter-list">
            ...
            <ul>
                ...
                <li class="active"><a href="/my-courses/jfmd/jfmd03">Chapter 3: Designing User Interfaces with XML and Java</a></li>
                <li><a href="/my-courses/jfmd/jfmd04">Chapter 4: Handling User Input and Storing App Data</a></li>
        ...
        <div class="main-content">
            ...
            <div class="next-chapter">
                <a href="/my-courses/jfmd/jfmd04" class="next-chapter-button">Next Chapter</a>
            </div>
        </div>
    </div>
