    ...
    <div class="container">
        ...
        <div class="chapter-list">
            ...
            <ul>
                ...
                <li class="active"><a href="/my-courses/jffb/jffb04">Chapter 4: Introduction to Object-Oriented Programming Concepts</a></li>
        ...
        System.out.println("Meow");
            ...
            <script>
                document.querySelector('.next-chapter-button').addEventListener('click', function(event) {
                    ...
                    const apiUrl = '/api/lesson/finish?id=JFB04';
