    ...
    <div class="container">
        ...
        <div class="chapter-list">
            ...
            <ul>
                ...
                <li class="active"><a href="/my-courses/jffb/jffb03">Chapter 3: Control Flow and Decision-Making in Java</a></li>
...
do {
    ...
    i++;
            ...
            <div class="next-chapter">
                <a href="/my-courses/java-for-beginners/chapter-4" class="next-chapter-button">Next Chapter</a>
            </div>
            <script>
                document.querySelector('.next-chapter-button').addEventListener('click', function(event) {
                    event.preventDefault();
                    const apiUrl = '/api/lesson/finish?id=JFB03';
