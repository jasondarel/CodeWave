    ...
    <div class="container">
        ...
        <div class="chapter-list">
            ...
            <ul>
                ...
                <li class="active"><a href="/my-courses/jffb/jffb05">Chapter 5: Working with Arrays, Lists, and Other Data Structures in Java</a></li>
            </ul>
        </div>
...
System.out.println(map.get("Banana"));  // Output: 2</code></pre>
            ...
            <script>
                document.querySelector('.next-chapter-button').addEventListener('click', function(event) {
                    ...
                    const apiUrl = '/api/lesson/finish?id=JFB05';
