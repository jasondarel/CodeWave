...
<body>
    ...
    <div class="container">
        ...
        <div class="chapter-list">
            <h3>CHAPTERS</h3>
            <ul>
                <li class="active"><a href="/my-courses/itf/itf01">Chapter 1: Introduction to Flask and Setting up a Flask Environment</a></li>
                <li><a href="/my-courses/itf/itf02">Chapter 2: Building Your First Flask App</a></li>
                <li><a href="/my-courses/itf/itf03">Chapter 3: Understanding Flask Routing and HTTP Methods</a></li>
        ...
        <div class="main-content">
            ...
            <div class="next-chapter">
                <a href="/my-courses/itf/itf02" class="next-chapter-button">Next Chapter</a>
            </div>
        </div>
    </div>
