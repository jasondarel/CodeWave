...
<body>
    ...
    <div class="container">
        ...
        <div class="chapter-list">
            <h3>CHAPTERS</h3>
            <ul>
                <li class="active"><a href="/my-courses/pfml/pfml01">Chapter 1: Introduction to Machine Learning and Its Applications</a></li>
                ...
                <li><a href="/my-courses/pfml/pfml05">Chapter 5: Building and Deploying Machine Learning Models</a></li>
            </ul>
        </div>
        ...
        <div class="main-content">
            ...
            <div class="next-chapter">
                <a href="/my-courses/pfml/pfml02" class="next-chapter-button">Next Chapter</a>
            </div>
        </div>
    </div>
