...
<body>
    ...
    <div class="container">
        ...
        <div class="chapter-list">
            <h3>CHAPTERS</h3>
            <ul>
                <li><a href="/my-courses/fdwr/fdwr01">Chapter 1: Understanding React components and JSX</a></li>
                ...
                <li class="active"><a href="/my-courses/fdwr/fdwr04">Chapter 4: React Router for building multi-page applications</a></li>
    ...
    return (
        <Router>
            ...
            <div class="next-chapter">
                <a href="/my-courses/fdwr/fdwr05" class="next-chapter-button">Next Chapter</a>
            </div>
        </div>
    </div>
