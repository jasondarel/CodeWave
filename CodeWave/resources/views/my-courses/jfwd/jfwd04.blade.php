    ...
    <div class="container">
        ...
        <div class="chapter-list">
            ...
            <ul>
                ...
                <li class="active"><a href="/my-courses/jfwd/jfwd04">Chapter 4: Asynchronous JavaScript: Working with AJAX</a></li>
                <li><a href="/my-courses/jfwd/jfwd05">Chapter 5: Integrating JavaScript with third-party libraries and APIs</a></li>
            </ul>
        </div>
...
fetch('https://jsonplaceholder.typicode.com/posts')
  ...
  .catch(error => console.log('Error:', error));
            ...
            <div class="next-chapter">
                <a href="/my-courses/jfwd/jfwd05" class="next-chapter-button">Next Chapter</a>
            </div>
        </div>
    </div>
