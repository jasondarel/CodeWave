    ...
    <div class="container">
        ...
        <div class="chapter-list">
            ...
            <ul>
                ...
                <li><a href="/my-courses/wdwd/wdwd04">Chapter 4: Implementing User Authentication and Authorization</a></li>
                <li class="active"><a href="/my-courses/wdwd/wdwd05">Chapter 5: Deploying Django Applications to Production Servers</a></li>
            </ul>
        </div>
        ...
        <div class="main-content">
            ...
            <div class="next-chapter">
                <a href="/my-courses/wdwd" class="next-chapter-button">Return to Course Overview</a>
            </div>
        </div>
    </div>
