    ...
    <div class="container">
        ...
        <div class="chapter-list">
            ...
            <ul>
                ...
                <li class="active"><a href="/my-courses/nfbd/nfbd02">Chapter 2: Working with Express.js for building RESTful APIs</a></li>
...
app.delete('/items/:id', (req, res) => {
    ...
    res.status(204).send();
            ...
            <div class="next-chapter">
                <a href="/my-courses/nfbd/nfbd03" class="next-chapter-button">Next Chapter</a>
            </div>
        </div>
    </div>
