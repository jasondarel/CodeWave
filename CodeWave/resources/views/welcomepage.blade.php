...
<body>
    ...
    <div class="mx-auto max-w-lg flex flex-row pt-4 gap-4">
        ...
        <div class="flex flex-grow-0 self-start gap-2 flex-row bg-slate-600 shadow-md rounded-lg p-[7px]">
            ...
            <div class="bg-[url('https://img.icons8.com/?size=100&id=123603&format=png&color=000000')] h-6 w-6 bg-cover"></div> <div class="text-white font-normal font-lexend">React</div>

    </div>

    <div class="flex flex-grow-0 self-start gap-2 flex-row bg-orange-400 shadow-md rounded-lg p-[7px]">
        
            <div class="bg-[url('https://img.icons8.com/?size=100&id=WZCcsYDBHITs&format=png&color=000000')] h-6 w-6 bg-cover"></div> <div class="text-white font-normal font-lexend">Python</div>
    </div>
    ...
    <div class="flex flex-grow-0 self-start gap-2 flex-row bg-red-400 shadow-md rounded-lg p-[7px]">
        <form action="{{ route('logout') }}" method="post">
            ...
            <div class="bg-[url('https://img.icons8.com/?size=100&id=WZCcsYDBHITs&format=png&color=000000')] h-6 w-6 bg-cover"></div> <div class="text-white font-normal font-lexend">
