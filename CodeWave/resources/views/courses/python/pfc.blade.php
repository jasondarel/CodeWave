...
<body>
    ...
    <div class="course-content">
        <div class="course-section">
            ...
            <p>
                This course is designed to introduce you to the role of Python in cybersecurity. You will learn how to use Python for tasks such as network scanning, penetration testing, automating vulnerability assessments, and writing security tools. By the end of this course, you’ll be equipped with the skills to apply Python in cybersecurity contexts and enhance your security practices.
            </p>
        </div>
        ...
        <a href="/enroll/python-for-cybersecurity" class="cta-button mt-20">Enroll Now</a>
    </div>
