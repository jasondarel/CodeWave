...
<body>
    ...
    <div class="allcontent">
        ...
        <div class="courses d-flex align-content-start flex-wrap gap-4 mb-5">
            ...
            ['title' => 'Frontend Development with React', 'description' => 'Build interactive UIs using React, one of the most popular JavaScript libraries.', 'image' => 'https://i.pinimg.com/originals/5c/7b/53/5c7b53a7be1dd267f24f7559584d1345.jpg'],
            ...
            ['title' => 'Full-Stack Development with Node.js and Express', 'description' => 'Learn server-side JavaScript development using Node.js and build scalable applications.', 'image' => 'https://miro.medium.com/v2/resize:fit:1400/1*f7ztMaMM0etsFHpEfkdiwA.png']
            ] as $course)
            <div class="card" style="width: 18rem;">
                <img src="{{ $course['image'] }}" class="card-img-top" alt="{{ $course['title'] }}">
                <div class="card-body d-flex flex-column justify-content-between gap-3">
