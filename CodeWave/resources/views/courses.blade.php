            ...
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body d-flex flex-column justify-content-between gap-3">
                    ...
                    @else
                        ...
                        <a href="{{$course_url($course['id'])}}" class="btn btn-primary" >View</a>
                        @else
