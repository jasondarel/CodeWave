...
Route::middleware('auth')->group(function () {
    // Route ke halaman inbox dengan data notifikasi
...
// Halaman tambahan dari branch main
...
// Detail inbox berdasarkan ID notifikasi
